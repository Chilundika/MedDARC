        ...
        echo "
          ...
          <div class='ci_box'>
            ...
            <h3> Contact Info</h3>
              ...
              <hr>
              <a href='staff_info_edit.php' style='color: #007bff; text-decoration: none; padding: 5px 20px; background-color: #333; color: #fff; border-radius: 5px; text-align: center;'>Edit</a>
            </div>
          </div><br>
          <div class='res_div'><a class='res' href='s_res_pass.php' style='color: #007bff; text-decoration: none; padding: 8px 20px; background-color: #333; color: #fff; border-radius: 5px; text-align: center;'>Reset Password</a></div>
        ";
      }
    }
   ?>
