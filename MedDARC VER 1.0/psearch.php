...
<main>
    <div class="welcome">
      <div class="welcome_mssg">
        ...
        <hr>
        <h3 style="text-align: center;">Fill out all fields to search for required information</h3>
        <hr>
      </div>
  ...
  <div class="form-box">
    ...
    <form class="search-form" action="psearch.php" method="post">
      ...
      <input type="text" name="did" placeholder="Enter Doctor Or Staff ID" required><br>
      <label for="date"><span class="content-name">Date</span></label>
      <input type="text" id="date" name="date" placeholder="Enter a valid date" required><br>
      <script>
      jQuery(function($) {
          $("#date").datepicker();
      });
      ...
      <input type="text" id="time" name="time" placeholder="Enter a valid time" required><br>
      <script>
      jQuery(function($) {
          $("#time").timepicker({
            timeFormat: "hh:mm tt"
      ...
      <input type="text" name="ref" placeholder="Enter a valid Reference Number" required><br>
      <input type="submit" name="search-submit" value="Search" style="background-color: lightskyblue;">
